                        ...
                        children: [
                          ...
                          RefreshIndicator(
                            key: _refreshIndicatorKey2,
                              onRefresh: _pullRefresh,
                              child: VisualizzaDenunceWidget(denunce:listaDenunce.where((event) => event.statoDenuncia==StatoDenuncia.PresaInCarico).toList())),
                          //3rd tab
                          RefreshIndicator(
                              key: _refreshIndicatorKey3,
                              onRefresh: _pullRefresh,
                              child: VisualizzaDenunceWidget(denunce:listaDenunce.where((event) => event.statoDenuncia==StatoDenuncia.Chiusa).toList() ))
                        ],
                      );
                    }
                  }
