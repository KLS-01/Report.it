              ...
              builder: (context, utente, _) {
                if (utente?.tipo == TipoUtente.Utente) {
                  return FutureBuilder<SPID?>(
                    future: AuthenticationService(FirebaseAuth.instance).getSpid(utente?.id),
                    builder: (BuildContext context, AsyncSnapshot<SPID?> snapshot) {
                     return  FloatingActionButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  InoltroDenuncia(utente: utente!,spid: snapshot.data!,),
                            ),
                          );
                        },
