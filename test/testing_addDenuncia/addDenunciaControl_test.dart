...
void main(){
  ...
  funzioneTest({required String nomeDenunciante,
  ...
  group("AddDenuncia", () {
    test("TC_2.1_1_1", (() async {
      ...
      Timestamp scadenzaDocDenunciante=Timestamp.fromDate(DateTime.parse("2030-12-12"));
      CategoriaDenuncia categoriaDenuncia= CategoriaDenuncia.Colore;
      String nomeVittima="Gonzalo";
      String denunciato="Fabio Santini";
      String descrizione="Il signor Fabio Santini il giorno 20/03/2023 mi ha negato il servizio nel suo ristorante usando come motivazione che essendo di colore non potessi permettermi di pagare il conto.";
    ...
    test("TC_2.1_1_2", (() async {
      ...
      String nomeDenunciante="Alberto";
      String cognomeDenunciante="Genovese";
      String indirizzoDenunciante="Via Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean fermentum mi a nibh rutrum, sed scelerisque enim efficitur. Fusce accumsan id mi quis hendrerit. Vivamus ut tincidunt orci, 46";
      String provinciaDenunciante="SA";
      String cellulareDenunciante="+393802110703";
      String emailDenunciante="g.ortiz@gmail.com";
      String? tipoDocDenunciante="Carta Identita";
    ...
    test("TC_2.1_1_10", (() async {
      ...
      CategoriaDenuncia categoriaDenuncia= CategoriaDenuncia.Colore;
      String nomeVittima="Gonzalo";
      String denunciato="Giuseppe Fabio Pierferdinando Santini Quondamangelomaria Garibaldi";
      String descrizione="Il signor Fabio Santini il giorno 20/03/2023 mi ha negato il servizio nel suo ristorante usando come motivazione che essendo di colore non potessi permettermi di pagare il conto.";
      String cognomeVittima="Ortiz";
      bool consenso=true;
      bool? alreadyFiled=false;
    ...
    test("TC_2.1_1_11", (() async {
      ...
      String nomeVittima="Gonzalo";
      String denunciato="Fabio Santini";
      String descrizione="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sed ipsum at mauris pulvinar auctor. Duis sit amet quam tellus. Suspendisse potenti. Cras leo magna, hendrerit vel nisi eget, egestas fringilla tellus. Cras luctus lacus augue, eu accumsan ante dictum et. Nulla tincidunt ligula ut ultrices laoreet. "
    ...
    test("TC_2.1_1_14", (() async {
      String capDenunciante="84016";
      String nomeDenunciante="Albertofeargewrgergfawrtegwegweartgvrwtgvterwgveartw";
      String cognomeDenunciante="Genovese";
      String indirizzoDenunciante="Via Traversa Taurano, 46";
      String provinciaDenunciante="SA";
      String cellulareDenunciante="+393802110703";
    ...
    test("TC_2.1_1_15", (() async {
      String capDenunciante="84016";
      String nomeDenunciante="Alberto";
      String cognomeDenunciante="Genoveseefgwefgwerfgewgfwerfgewgfewrtfgerfgrewfgew";
      String indirizzoDenunciante="Via Traversa Taurano, 46";
      String provinciaDenunciante="SA";
      String cellulareDenunciante="+393802110703";
      String emailDenunciante="g.ortiz@gmail.com";
    ...
    test("TC_2.1_1_18", (() async {
      ...
      Timestamp scadenzaDocDenunciante=Timestamp.fromDate(DateTime.parse("2010-12-12"));
      CategoriaDenuncia categoriaDenuncia= CategoriaDenuncia.Colore;
      String nomeVittima="Gonzalo";
      String denunciato="Fabio Santini";
      String descrizione="Il signor Fabio Santini il giorno 20/03/2023 mi ha negato il servizio nel suo ristorante usando come motivazione che essendo di colore non potessi permettermi di pagare il conto.";
